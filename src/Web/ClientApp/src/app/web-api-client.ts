...
export interface IForecastsClient {
    ...
    getForecastByCityRecent(city: string | null | undefined): Observable<GetForecastByCityRecentQueryDto[]>;
...
export class ForecastsClient implements IForecastsClient {
    ...
    getAllForcastByID(uniqueId: string | null | undefined): Observable<ResultOfGetForecastByIdQueryDto> {
        let url_ = this.baseUrl + "/api/Forecasts/GetAllForcastByID?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllForcastByID(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllForcastByID(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ResultOfGetForecastByIdQueryDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ResultOfGetForecastByIdQueryDto>;
        }));
    }

    protected processGetAllForcastByID(response: HttpResponseBase): Observable<ResultOfGetForecastByIdQueryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getForecastByCityRecent(city: string | null | undefined): Observable<GetForecastByCityRecentQueryDto[]> {
        let url_ = this.baseUrl + "/api/Forecasts/GetForecastByCityRecent?";
        if (city !== undefined && city !== null)
            url_ += "City=" + encodeURIComponent("" + city) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetForecastByCityRecent(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetForecastByCityRecent(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetForecastByCityRecentQueryDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetForecastByCityRecentQueryDto[]>;
        }));
    }

    protected processGetForecastByCityRecent(response: HttpResponseBase): Observable<GetForecastByCityRecentQueryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(GetForecastByCityRecentQueryDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export class ResultOfGetForecastByIdQueryDto implements IResultOfGetForecastByIdQueryDto {
    data?: GetForecastByIdQueryDto | undefined;
    message?: string;
    resultType?: ResultType;

    constructor(data?: IResultOfGetForecastByIdQueryDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.data = _data["data"] ? GetForecastByIdQueryDto.fromJS(_data["data"]) : <any>undefined;
            this.message = _data["message"];
            this.resultType = _data["resultType"];
        }
    }

    static fromJS(data: any): ResultOfGetForecastByIdQueryDto {
        data = typeof data === 'object' ? data : {};
        let result = new ResultOfGetForecastByIdQueryDto();
        result.init(data);
        return result;
    }
...
export interface IResultOfGetForecastByIdQueryDto {
    data?: GetForecastByIdQueryDto | undefined;
    message?: string;
    resultType?: ResultType;
}

export class GetForecastByIdQueryDto implements IGetForecastByIdQueryDto {
    id?: number | undefined;
    forecastName?: string | undefined;
    city?: string | undefined;
    temperature?: string | undefined;
    ...
    constructor(data?: IGetForecastByIdQueryDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetForecastByIdQueryDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetForecastByIdQueryDto();
        result.init(data);
        return result;
    }
...
export class GetForecastByCityRecentQueryDto implements IGetForecastByCityRecentQueryDto {
    id?: number | undefined;
    forecastName?: string | undefined;
    city?: string | undefined;
    temperature?: string | undefined;
    ...
    constructor(data?: IGetForecastByCityRecentQueryDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetForecastByCityRecentQueryDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetForecastByCityRecentQueryDto();
        result.init(data);
        return result;
    }
...
export interface IGetForecastByCityRecentQueryDto {
    id?: number | undefined;
    forecastName?: string | undefined;
    city?: string | undefined;
    temperature?: string | undefined;
